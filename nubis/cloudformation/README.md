...
```bash
ssh -A -t ec2-user@jumphost.sandbox.nubis.allizom.org "ssh -A -t ubuntu@$(nubis-consul --stack-name nubis-siege --settings nubis/cloudformation/parameters.json get-ec2-instance-ip)"
```
